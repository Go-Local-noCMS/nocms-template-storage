...
export function Divider({ motif, className = "" }: DividerProps) {
  ...
  if (resolvedMotif === "leaf") {
    return (
      <div data-nocms-component="divider" className={`flex items-center justify-center gap-4 py-6 ${className}`} aria-hidden="true">
  ...
  if (resolvedMotif === "golden-dot") {
    return (
      <div data-nocms-component="divider" className={`flex items-center justify-center gap-3 py-6 ${className}`} aria-hidden="true">
  ...
  /* line (default) */
  return (
    <div data-nocms-component="divider" className={`py-6 ${className}`} aria-hidden="true">
